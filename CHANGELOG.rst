...
Unreleased
----------
* feat: support Python 3.15 and its free-threaded build. Wheels for them are published for x86_64 and i686 manylinux, whose build images already ship 3.15; elsewhere ``pip`` builds from source (a Rust toolchain is needed) until a follow-up release adds the remaining wheels.
